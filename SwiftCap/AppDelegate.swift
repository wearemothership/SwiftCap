...
class AppDelegate: NSObject, NSApplicationDelegate, SCStreamDelegate, SCStreamOutput {
    ...
    let excludedWindows = ["", "com.apple.dock", "com.apple.controlcenter", "com.apple.notificationcenterui", "com.apple.systemuiserver", "com.apple.WindowManager", "com.mothership.SwiftCap", "com.gaosun.eul", "com.pointum.hazeover", "net.matthewpalmer.Vanilla", "com.dwarvesv.minimalbar", "com.bjango.istatmenus.status"]
        ...
        do {
            ...
            switch error {
                case SCStreamError.userDeclined:
                    infoItem.title = "SwiftCap requires screen recording permissions.".local
                    requestPermissions()
                default:
            ...
            infoMenu.addItem(NSMenuItem(title: "Quit".local, action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q"))
